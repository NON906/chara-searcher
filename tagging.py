...
tagger_path = None
if os.path.exists(os.path.join(os.path.dirname(__file__), '..', 'stable-diffusion-webui-wd14-tagger')):
    tagger_path = os.path.join(os.path.dirname(__file__), '..', 'stable-diffusion-webui-wd14-tagger')
elif os.path.exists(os.path.join(os.path.dirname(__file__), '..', 'tagger')):
    tagger_path = os.path.join(os.path.dirname(__file__), '..', 'tagger')
